...
import com.example.acer.datamahasiswa.R;
...
public class DisplayMhs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydb = new DBHelper(this);Bundle extras = getIntent().getExtras();
        if(extras !=null) {
    ...
    public void  run (View view)
    {
        if (nomhs.getText().toString().equals("")||
            ...
            Intent i = new Intent(getApplicationContext(), com.example.datamahasiswa.MainActivity.class);
            startActivity(i);
        }
    }
